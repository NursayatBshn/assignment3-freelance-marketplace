...
This project is a **console-based Java application** that simulates a **freelance marketplace**. It demonstrates how object-oriented programming principles can be combined with **JDBC** to work with a **real PostgreSQL database** using a clean multi-layer architecture.
...
PostgreSQL SQLState `23505` (UNIQUE violation) is converted into a `DuplicateResourceException` in the service layer.
...
2. Create database and tables using `schema.sql`
...
* Reading all projects from database
* Creating a bid
* Triggering duplicate bid error

Screenshots of console output and database tables are provided.
...
* Enforce business rules both at database and service levels
* Handle SQL exceptions and convert them into meaningful business errors

The main challenge was correctly synchronizing Java objects with database constraints, especially foreign keys and unique constraints. This project helped me understand how backend systems are built in real applications.
